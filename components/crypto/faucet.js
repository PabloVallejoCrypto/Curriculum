		...
		<div className='col-lg-12 mx-auto text-center'>
			...
			<div className='row mx-auto' style={rowStyle}>
				<div className='col-lg-5 mx-auto cardStyle2' style={morePadding}>
					...
					<a href='https://testnet.binance.org/faucet-smart' style={linkNoStyle}><button className='btn mb-3 linkGroc' style={arialStyle}>  FREE BNB  </button></a>
				</div>
				<div className='col-lg-5 mx-auto cardStyle2' style={morePadding}>
					<h1 className='display-6'>  Chaotic BCN    </h1>
					<p>  If you don't see your token at wallet, add it with the contract address.  </p>
					<a href='https://testnet.bscscan.com/token/0x655E53dB0d79075A02E6c6e576fef40304218721' style={linkNoStyle}><button className='btn mb-3 linkGroc' style={arialStyle}>  Contract Address  </button></a>
					<button className='btn mb-3 linkGroc' onClick={chaosFaucet} style={arialStyle}>  FREE XΟΣ  </button>
				</div>
			</div>
