		...
		<div className="row mx-auto text-center mb-3">
			<div className='col-lg-5 cardStyle mx-auto' style={cardStyle}>
				...
				<div className='col-lg-12 mx-auto' style={innerCardStyle}>
					...
					<span className='btn mb-3 badgeBlack'><h1 className='lead'>  CSS3  </h1></span>
			...
			<div className='col-lg-5 cardStyle mx-auto' style={cardStyle}>
				...
				<div className='col-lg-12 mx-auto lead' style={innerCardStyle}>
					...
					<span className='btn mb-3 badgeBlack'><h1 className='lead'>  ReactJS  </h1></span>
					...
					<span className='btn mb-3 badgeBlack'><h1 className='lead'>  ExpressJS  </h1></span>
					...
					<span className='btn mb-3 badgeBlack'><h1 className='lead'>  Ethereum(EVM)  </h1></span>
					<span className='btn mb-3 badgeBlack'><h1 className='lead'>  Binance Smart Chain  </h1></span>
